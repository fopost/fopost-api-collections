...
The **published contract of the FoPost API**: `openapi.json` (OpenAPI 3.1, 265 paths / 371
operations across 20 groups) plus ready-to-run client collections generated from it — a Postman
